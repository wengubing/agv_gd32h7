...
#define PLL_Q      8  		//8:160M  7:168M		dyÐÞ¸Ä.2016.02.26
...
#define PLL_N      320		//320:160M  336:168MS  dyÐÞ¸Ä.2016.02.26
/* SYSCLK = PLL_VCO / PLL_P */
#define PLL_P      2
...
#if defined(STM32F40_41xxx)
  uint32_t SystemCoreClock = 160000000;//dyÐÞ¸Ä.2016.02.26
#endif /* STM32F40_41xxx */
...
{
	uint32_t tmp = 0, pllvco = 0, pllp = 2, pllsource = 0, pllm = 2;//168M

	if(SystemCoreClock==168000000)
	{
		tmp = 0x00; pllvco = 0x00; pllp = 0x02; pllsource = 0; pllm = 0x02;//168M
	}
	else if(SystemCoreClock==160000000)
	{
		tmp = 0x08; pllvco = 0x00; pllp = 0x02; pllsource = 0x01; pllm = 0x02;//160M
	}
