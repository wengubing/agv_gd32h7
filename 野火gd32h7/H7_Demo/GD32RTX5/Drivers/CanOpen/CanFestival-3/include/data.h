...
struct struct_CO_Data {
	/* Object dictionary */
	UNS8 SlaveNodeid;	//2015.12.31添加.by dengyang 
    UNS8 CurrntMaxNodeid;  //2018.03.19添加.by biyabc
	UNS8 *bDeviceNodeId;
...
#define CANOPEN_NODE_DATA_INITIALIZER(NODE_PREFIX) {\
	/* Object dictionary*/\
	0,                								 	 /* CurrntSlaveNodeid 添加 by dengyang 2016.03.09*/\
    MAX_NodeId_NUM,                      /* CurrntMaxNodeid 添加 by biyabc 2018.03.19*/\
