...
LinkCanopenMaster_EXT	void tsk_canopen_master(LinkCanOpen *pCm, CO_Data* d, UNI_CANi *p_stCAN);
LinkCanopenMaster_EXT	void CanFestivalTimer_Dispatch(void);
LinkCanopenMaster_EXT	void CanFestivalTimer_Ctrl(ControlStatus NewState);

LinkCanopenMaster_EXT	void canfestival_timer_start();
LinkCanopenMaster_EXT	void can_master_init(UNI_CANi *p_stCAN, CO_Data* d, ControlStatus NewState);
LinkCanopenMaster_EXT	UNS8 canSend(CAN_PORT notused, Message *m);

LinkCanopenMaster_EXT	void Tsk_CanOpen_RxMsgPro(CO_Data* d, UNI_CANi *PCAN);
LinkCanopenMaster_EXT	void Tsk_CanOpen_TxMsgPro(CO_Data* d, UNI_CANi *PCAN);
