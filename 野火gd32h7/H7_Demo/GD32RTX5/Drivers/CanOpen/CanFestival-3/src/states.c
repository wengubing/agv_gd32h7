...
//				s_state_communication newCommunicationState = {1, 0, 0, 0, 0, 0, 0};
				s_state_communication newCommunicationState = {0, 0, 0, 0, 0, 0, 0};//作为主机时,不需要发送bootup报文!!!
...
//				s_state_communication newCommunicationState = {0, 1, 1, 1, 1, 0, 1};
				s_state_communication newCommunicationState = {0, 1, 1, 0, 1, 0, 1};//Pre_operational : 先关闭 csSYNC
			...
			{
				s_state_communication newCommunicationState = {0, 1, 1, 1, 1, 1, 0};//Operational : 再打开 csSYNC
...
//				s_state_communication newCommunicationState = {0, 0, 0, 0, 1, 0, 1};
				s_state_communication newCommunicationState = {0, 0, 0, 0, 0, 0, 1};// Stopped : 关闭 csLifeGuard
				d->nodeState = Stopped;
				newState = Stopped;
				switchCommunicationState(d, &newCommunicationState);
				(*d->stopped)(d);
