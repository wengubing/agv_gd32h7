...
/** 触发 板载LED 条件 
  ...
  * 0 - on
  */
#define LED1_LED2_LED3_LED_ON  0
#define LED1_LED2_LED3_LED_OFF 1


/* 使用标准的固件库控制IO*/
#define LED_1(A)	if (A)    gpio_bit_set(LED1_GPIO_PORT,LED1_GPIO_PIN);\
					else    gpio_bit_reset(LED1_GPIO_PORT,LED1_GPIO_PIN)
#define LED_2(A)	if (A)    gpio_bit_set(LED2_GPIO_PORT,LED2_GPIO_PIN);\
					else    gpio_bit_reset(LED2_GPIO_PORT,LED2_GPIO_PIN)
#define LED_3(A)	if (A)    gpio_bit_set(LED3_GPIO_PORT,LED3_GPIO_PIN);\
					else    gpio_bit_reset(LED3_GPIO_PORT,LED3_GPIO_PIN)
...
/* 单灯操作 */
//LED1
#define LED1_LED_EX_ON_ONLY         LED1_ON    \
                                    LED2_OFF   \
                                    LED3_OFF

//LED2
#define LED2_LED_EX_ON_ONLY		    LED1_OFF   \
                                    LED2_ON    \
                                    LED3_OFF
					
//LED3
#define LED3_LED_EX_ON_ONLY	        LED1_OFF   \
                                    LED2_OFF   \
                                    LED3_ON
					
//LED全亮
#define LED1_LED2_LED3_EX_ALL_ON    LED1_ON    \
                                    LED2_ON    \
                                    LED3_ON
					               
//LED全灭
#define LED1_LED2_LED3_EX_ALL_OFF   LED1_OFF   \
                                    LED2_OFF   \
                                    LED3_OFF
